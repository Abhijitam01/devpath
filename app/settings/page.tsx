      ...
      <Tabs defaultValue="profile" className="w-full">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="bio" defaultValue="Full-stack developer passionate about building useful applications." />
              </div>
            </CardContent>
            <CardFooter>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Receive notifications when someone upvotes your projects.
                  </p>
                </div>
        ...
        <TabsContent value="account" className="space-y-6 mt-6">
          ...
          <Card className="border-destructive">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                This action cannot be undone. All your projects, comments, and personal data will be permanently
                removed.
              </p>
            </CardContent>
            <CardFooter>
